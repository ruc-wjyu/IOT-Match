...
data_extract_json = '/new_disk2/zhongxiang_sun/code/explanation_project/explanation_model/dataset/our_data/heat_map/temp.json'
data_extract_npy = '/new_disk2/zhongxiang_sun/code/explanation_project/explanation_model/dataset/our_data/heat_map/temp.npy'
...
class OT(nn.Module):
    def __init__(self, reg=0.5, mass=0.5, numItermax=10):
        ...
        self.weight = args['class_mask_weight']
